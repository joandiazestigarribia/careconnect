...
import { Search, MapPin, AlertCircle, Loader2, ChevronDown, X, Users, Heart, LayoutDashboard } from 'lucide-react';
...
const CaregiverDashboard = () => {
  ...
  useEffect(() => {
    ...
    if (savedFilters) {
      ...
      setFamilyAddress(savedFilters.address);
      setFamilyRadius(savedFilters.radius_km);
      setMaxChildren(savedFilters.max_children_count ?? '');
      setFamilyLanguages(savedFilters.preferred_languages);
      setFamilyUseCustomAddress(savedFilters.use_custom_address);
  ...
  const isDefaultState = 
    familyAddress === COMMON_ADDRESSES[0].value &&
    familyRadius === 5 &&
    maxChildren === '' &&
    familyLanguages.length === 1 &&
    familyLanguages[0] === 'Español' &&
    familyUseCustomAddress === false;
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1">
          <div className="bg-surface rounded-3xl shadow-xl shadow-primary/10 border-2 border-border overflow-hidden">
            ...
            <form onSubmit={handleFamilySearch} className="px-5 pb-5 space-y-5 mt-5">
              {/* Ubicación */}
              <div>
          ...
          <div className="mt-6 bg-surface rounded-3xl shadow-lg shadow-primary/5 border-2 border-border p-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {!hasSearchedFamilies && !isLoadingFamilies && !isLoadingSavedSearch && (
          ...
          {(isLoadingFamilies || isLoadingSavedSearch) && (
            <div className="text-center py-16 bg-gradient-to-br from-surface to-bg-main rounded-3xl border border-border shadow-lg">
