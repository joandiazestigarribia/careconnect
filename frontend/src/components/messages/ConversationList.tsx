  ...
  if (conversations.length === 0) {
    return (
      <div className="text-center py-12">
        <div className="w-20 h-20 bg-linear-to-br from-primary/10 to-primary-light/10 rounded-3xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-primary/10">
        ...
        return (
          <button
            ...
            className={`w-full flex items-center gap-3 p-4 rounded-2xl transition-all duration-300 text-left ${isSelected
              ? 'bg-linear-to-r from-primary/10 to-primary-light/10 border-2 border-primary/30 shadow-md shadow-primary/10'
              : 'bg-surface border-2 border-border hover:border-primary/30 hover:shadow-md'
              }`}
          >
            <div className="w-12 h-12 bg-linear-to-br from-primary to-primary-light rounded-full flex items-center justify-center shrink-0 shadow-md shadow-primary/20">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2">
                ...
                {unread > 0 && (
                  <span className="shrink-0 w-6 h-6 bg-linear-to-br from-primary to-accent text-white text-xs font-bold rounded-full flex items-center justify-center shadow-md shadow-primary/20">
                    {unread > 9 ? '9+' : unread}
                  </span>
                )}
              </div>
